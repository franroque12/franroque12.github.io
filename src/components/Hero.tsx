...
export default function Hero() {
  const { t } = useI18n();
  const roles = [t.roles.quality, t.roles.automation, t.roles.performance, t.roles.lead];
      ...
      <div className="relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20 px-6 w-full max-w-6xl mx-auto">
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            FRANCISCO
            <br />
            <span className="text-blue-500">ROQUE</span>
          </motion.h1>
          ...
          >
            <a
              href="#about"
              className="inline-flex items-center gap-2 text-xs tracking-[0.3em] uppercase text-white hover:text-blue-500 transition-colors duration-500"
            >
              <motion.span
                animate={{ y: [0, 6, 0] }}
        ...
        >
          <div className="w-48 h-48 sm:w-64 sm:h-64 rounded-full bg-neutral-900 border border-blue-500/20 overflow-hidden">
            <Image
