...
function BeyondTheRoleCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-bold text-white mb-3 group-hover:text-blue-500 transition-colors duration-500">
        {name}
      </h3>
