  ...
  return (
    ...
    >
      <div className="flex items-start gap-6 sm:gap-10">
        <span className="text-[11px] tracking-[0.3em] text-blue-500 font-mono mt-2 shrink-0">
          {number}
        </span>
        <div className="flex-1">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight mb-4 group-hover:text-blue-500 transition-colors duration-500">
            {name}
          </h3>
...
export default function Work() {
  ...
  const areas = [
    { number: "01", ...t.work.quality },
    { number: "02", ...t.work.automation },
    { number: "03", ...t.work.consulting },
    { number: "04", ...t.work.teaching },
  ];
