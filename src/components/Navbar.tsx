    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="group">
          <span className="text-sm font-bold tracking-[0.2em] uppercase text-white group-hover:text-blue-500 transition-colors duration-300">
            FR
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <button
            ...
            className="text-[11px] font-bold tracking-[0.25em] text-blue-500 hover:text-blue-400 transition-colors duration-300"
          >
            {locale === "en" ? "PT" : "EN"}
          </button>
        </div>
          ...
          >
            <div className="px-6 py-8 flex flex-col gap-5">
              ...
              <button
                ...
                className="text-sm font-bold tracking-[0.2em] text-blue-500 hover:text-blue-400 transition-colors self-start"
              >
                {locale === "en" ? "PT" : "EN"}
              </button>
            </div>
